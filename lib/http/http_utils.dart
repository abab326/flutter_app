...
//        contentType: Headers.formUrlEncodedContentType, // 适用于post form表单提交
  ...
  static void get<T>(
    ...
    request(Method.GET, url, data, success: success, fail: fail);
  }
  ...
  static void post<T>(
    ...
    request(Method.POST, url, data, success: success, fail: fail);
  }
  ...
  // success：请求成功回调
  // error：请求失败回调
  static Future request<T>(Method method, String path, dynamic data,
